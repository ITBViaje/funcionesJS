...
function prueba(c) { //c es un parámetro de la función prueba. LOCAL.
    ...
    if(c === 3){
        ...
        console.log('c dentro del if vale: ' + c); // el valor que le pasemos a prueba
    ...
    console.log('c dentro de la funcion pero fuera del if, vale: ' + c); // el valor que le pasemos a prueba
